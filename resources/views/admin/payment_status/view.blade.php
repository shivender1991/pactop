            ...
            <div class="row">
                <div class="col-12">
                  ...
                  <div class="card-header">
                    <h4>All Payment Status</h4>
                    <div class="card-header-action">
                        <div class="input-group">
                        <a href="{{ route('admin.payment_status.create') }}" class="btn btn-primary float-right">Add Payment Status</a>
                        </div>
                    </div>
                  </div>
                  <div class="card-body">
                      ...
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.payment_status.edit', ['id'=>$data->id]) }}" class="badge badge-warning badge-shadow" title="edit"> <i class="far fa-edit"></i> </a>
