              ...
              <div class="col-12">
                <div class="card">
                  ...
                  @if($message = Session::get('success'))
                   ...
                   @endif
                  <div class="card-body">
                    <form method="post" id="params_form" method="post" action="{{ route('admin.params.update', $detail->id) }}">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" class="form-control" name="value" id="value" value="{{ $detail->value }}">
                        @if($errors->has('value'))
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        ...
                        <a href="{{ route('admin.params.view') }}" class="btn btn-primary">Back</a>
                      </div>
                    </div>
                    </form>      
                  </div>
