              ...
              <div class="col-12">
                <div class="card">
                  ...
                  @if($message = Session::get('success'))
                   ...
                   @endif
                  <div class="card-body">
                    <form method="post" id="params_form" method="post" action="{{ route('admin.params.store') }}">
                    @csrf
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <button class="btn btn-primary" type="submit">Add Params</button>
