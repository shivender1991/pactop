              ...
              <div class="col-12">
                <div class="card">
                  ...
                  @if($message = Session::get('success'))
                   ...
                   @endif
                  <div class="card-body">
                    <form method="post" id="card_status_form" method="post" action="{{ route('admin.card_status.update', $detail->id) }}">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        ...
                        <a href="{{ route('admin.card_status.view') }}" class="btn btn-primary">Back</a>
                      </div>
                    </div>
                    </form>      
                  </div>
