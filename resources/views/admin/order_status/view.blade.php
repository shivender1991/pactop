                ...
                <div class="col-12">
                  ...
                  <div class="card-header">
                    ...
                    <div class="card-header-action">
                        ...
                        <a href="{{ route('admin.order_status.create') }}" class="btn btn-primary float-right">Add Order Status</a>
                        </div>
                    </div>
                  </div>
                  <div class="card-body">
                      ...
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.order_status.edit', ['id'=>$data->id]) }}" class="badge badge-warning badge-shadow" title="edit"> <i class="far fa-edit"></i> </a>
